...
export default function InvoicePage() {
  ...
  return (
    <div className="invoice-page min-h-screen bg-gray-100 p-4 sm:p-6 print:bg-white print:p-0">
      <div
        className={`invoice-shell mx-auto max-w-[920px] overflow-hidden bg-white print:rounded-none print:shadow-none ${
      ...
      >
        ...
        <div className="mb-8 flex flex-wrap items-center justify-between gap-3 print:hidden">
          ...
          <div className="flex flex-wrap items-center gap-3">
            <a
              ...
              download
              className="inline-flex items-center rounded-lg border border-gray-300 bg-white px-4 py-2 text-sm text-gray-700 transition hover:border-gray-900 hover:text-gray-900"
            >
            ...
            <button
              ...
              className="inline-flex items-center rounded-lg bg-gray-900 px-4 py-2 text-sm text-white transition hover:bg-black"
            >
        ...
        {/* ── Invoice hero header ─────────────────────────────────────── */}
        <div
          className="invoice-hero border-b border-gray-200 px-4 py-6 sm:px-8"
        ...
        >
          <div className="flex flex-col gap-6 lg:flex-row lg:items-start lg:justify-between">
            ...
            <div className="min-w-0 space-y-2">
              ...
              <h2 className="text-2xl font-black leading-tight text-gray-900 sm:text-[30px]">
                {settings?.store_name || 'Cluster ERP'}
              </h2>
              {settings?.store_address && (
                <p className="max-w-xl whitespace-pre-line text-sm leading-6 text-gray-600">{settings.store_address}</p>
              )}
            ...
            {/* Invoice meta card */}
            <div
              className={`w-full shrink-0 rounded-2xl border px-5 py-4 text-sm lg:w-[260px] ${
                template.layout === 'classic'
            ...
            >
              ...
              {template.showPaymentStatus && (
                <div className="mt-2 flex items-center justify-between gap-4">
                  <span className={`font-semibold ${template.layout === 'modern' ? 'text-white' : 'text-gray-800'}`}>
                    Payment Status
                  </span>
                  <span
                    className={`inline-flex items-center gap-1 rounded-full px-2 py-1 text-xs font-bold uppercase tracking-wide ${
        ...
        {/* ── Billing / Order info cards ──────────────────────────────── */}
        <div className="invoice-summary-cards grid gap-5 border-b border-gray-200 px-4 py-6 sm:grid-cols-2 sm:px-8">
        ...
        <div className="invoice-table-wrap px-4 py-6 sm:px-8">
        ...
        {/* ── Terms + Totals ──────────────────────────────────────────── */}
        <div className="grid gap-5 px-4 pb-6 sm:px-8 lg:grid-cols-[minmax(0,1fr)_300px]">
        ...
        {/* ── Footer ─────────────────────────────────────────────────── */}
        <div className="border-t border-gray-200 px-4 py-5 text-center text-sm text-gray-500 sm:px-8">
